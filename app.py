...
st.markdown("### Before you start, please ensure you have your OpenAI API Key ready. Enter it in the sidebar to unlock the full potential of the AI Stock Screener Agent.") 
st.write("")
